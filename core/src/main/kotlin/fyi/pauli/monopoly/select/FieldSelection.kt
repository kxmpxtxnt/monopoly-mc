...
import fyi.pauli.monopoly.board.field.data.isFieldBlock
...
val selectField = listen<PlayerMoveEvent> { event ->
	...
	val block = event.player.getTargetBlockExact(300, FluidCollisionMode.NEVER)
	...
	if (marker.currentFieldContainer != field || !marker.isVisible) {
		marker.update(field)
	}
